    <!-- Footer code snippet -->
    <footer>
        <div class="footer__top__background">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col flex-grow-1 d-none d-lg-block"></div>

                    <div class="col justify-content-end mt-3 mt-lg-0">
        ...
        <div class="footer__bottom__background">
